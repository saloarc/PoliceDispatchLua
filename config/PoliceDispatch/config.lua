...
-- string.lower ш string.upper эх №рсюђрхђ ё №ѓёёъшьш ёшьтюырьш
-- яю§ђюьѓ юђфхыќэрџ єѓэъішџ ё ях№хфхыћтрэшхь.
local lu_rus, ul_rus = {}, {}
for i = 192, 223 do
...
function scandir(mask)
	-- Тючт№рљрхђ ьрёёшт тёхѕ єрщыют яю ьрёъх.
	local handle
	local t = {}
...
-- Ъыўї - Шьџдрщырбжтхђюь.wav. 
-- Хёыш цх я№хєшъё Light шыш Dark, ђю тюёя№юшчтюфшђёџ фтр чтѓър.
-- Чэрїхэшх - ьрёёшт шфхэђшєшърђю№ют ітхђют, ъюђю№ћх ъ эхьѓ юђэюёџђёџ.
-- Сћы эряшёрэ т№ѓїэѓў. Фшёяхђїх№ тюёя№юшчтюфшђ ышсю ях№тћщ ітхђ ртђю, ышсю юср,
-- хёыш ђ№рэёяю№ђ т ьрёёштх CARS_TO_SOUND_TWO_COLORS
COLORS = {
...
-- в№рэёяю№ђ, уфх фтющэющ ітхђ.
-- Тюёя№юшчтюфшђёџ ъръ "White Red Firetrack"
CARS_TO_SOUND_TWO_COLORS = {
	407, -- Firetruck
	416, -- Ambulance
	423, -- дѓ№уюэїшъ ё ью№юцхэћь
	424, -- BF Injection
	427, -- Enforcer
	428, -- Шэърёёрђю№
	429, -- Banshee
...
-- в№рэёяю№ђэћх ё№хфёђтр, №рёітхђър ъюђю№ћѕ эх чртшёшђ юђ ёшёђхьэюую ітхђр
CARS_WITH_DEF_COLOR = {
	[406]="Silver", -- Dumper
	...
	[449]="Not sound", -- в№рьтрщ
	[464]="Red", -- брьюыИђшъ
	[465]="Green", -- Тх№ђюыИђшъ
	[470]="Copper", -- Patriot
	[486]="Not sound", -- Сѓыќфючх№
	[501]="Brown", -- Тх№ђюыИђшъ
	[520]="Silver", -- Hydra
	[523]="Silver", -- HPV1000
	[525]="White", -- Tow Truck
	[528]="Blue", -- FBI Truck
	[532]="Not sound", -- Ъюьсрщэ
	[548]="Green", -- Cargobob
...
-- Ъырёёшєшърішш ртђю, ъюђю№ћх эрчћтрхђ фшёяхђїх№
-- Ъыўї - ШьџдрщырбЭрчтрэшхьРтђю.wav
-- Чэрїхэшх - шфћ ртђюьюсшыхщ, ъюђю№ћх ъ эшь юђэюёџђёџ.
CARS = {
	["2 Door"]={434, 542, 583},
...
-- №рщюэћ, ъюђю№ћх эх ючтѓїштрхђ фшёяхђїх№
-- Ъыўї: эрчтрэшх №рщюэр, чэрїхэшх: №рщюэ, эр ъюђю№ћщ чрьхэџђќ.
AREAS_NOT_VOICED = {
...
-- Хёыш т №рішш хёђќ тюя№юёшђхыќэюх ёыютю ш ъюф 1 шыш ъюф 0 ёыютю,
-- ъ я№шьх№ѓ: "Яюїхьѓ сћы юсњџтыхэ code-0?" шыш "Ъђю юсњџтшы ъюф 0?",
-- чтѓъ эх я№юшу№ћтрхђёџ.
QUESTION_WORDS = {
	"їђю", "яюїхьѓ", "чрїхь", "ъѓфр", "ъђю", "ъюуфр", "уфх", "юђъѓфр", "їхщ", "ъръ"
}
...
-- Фрыхх шфѓђ ьрёёштћ ё эрчтрэшџьш ртђюьюсшыхщ ш №рщюэют.
...
CAR_NAMES = {
	...
	[604] = "Glendale",
	[605] = "Sadler",
	[606] = "Baggage Trailer ЋAЛ",
	[607] = "Baggage Trailer ЋBЛ",

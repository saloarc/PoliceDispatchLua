...
function scandir(directory)
	-- Тючт№рљрхђ ьрёёшт тёхѕ єрщыют т фш№хъђю№шш.

    local i, t = 0, {}
    local pfile = io.popen('dir "'..directory..'" /b')
    for filename in pfile:lines() do
        i = i + 1
        -- хёыш ёюфх№цшђ ђюїъѓ (єрщы, р эх яряър)
...
-- Сћы эряшёрэ т№ѓїэѓў. Т ъюфх сх№хђёџ ђюыќъю ях№тћщ ітхђ ртђю, тђю№ющ шуэю№ш№ѓхђёџ.
COLORS = {
...
-- в№рэёяю№ђ, уфх фтр ітхђр шьхўђ чэрїхэшх
...
-- в№рэёяю№ђэћх ё№хфёђтр ё юсючэрїхээћь ітхђюь
CARS_WITH_DEF_COLOR = {
	[406]="Grey", -- Dumper
	[417]="Grey", -- Helicopter
	[425]="Green", -- Hunter
